    ...
    <div>
        ...
        <div v-show="tab === 'blocks'" class="grid xl:!grid-cols-6 md:!grid-cols-4 grid-cols-1 gap-3">
            ...
            <RouterLink v-for="item in list"
                class="flex flex-col justify-between rounded p-4 shadow bg-base-100 dark:bg-base100"
        ...
        <div v-show="tab === 'transactions'" class="bg-base-100 dark:bg-base100 rounded overflow-x-auto">
