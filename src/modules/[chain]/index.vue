...
<template>
  <div>
    ...
    <div class="brand-gradient-border mt-4 shadow">
      <div class="w-full h-full bg-black">
        <div class="flex justify-between px-4 pt-4 pb-2 text-lg font-semibold text-main text-white">
          <span class="truncate text-accent">{{ walletStore.currentAddress || 'Not Connected' }}</span>
        ...
        <div class="grid grid-cols-3 gap-4 px-4 pb-6 mt-4">
          ...
          <div class="brand-gradient-border">
            <label for="send" class="btn bg-radial-gradient-base-duo bg-base-100 dark:bg-base-100 w-full text-white"
              @click="dialog.open('send', {}, updateState)">{{
                $t('account.btn_send') }}</label>
          </div>
          <div class="brand-gradient-border">
            <label for="delegate" class="btn bg-radial-gradient-base-duo bg-base-100 dark:bg-base-100 w-full text-white"
    ...
    <div class="flex w-full flex-col gap-4 mt-4">
      ...
      <div class="text-white grow basis-0 min-w-0">
      ...
      <div v-if="!store.coingeckoId" class="text-white grow basis-0 min-w-0">
        <div class="flex items-center gap-1 px-4 pt-4 pb-2">
          <!-- <div class="p-2 rounded shadow bg-white/[0.2]">
