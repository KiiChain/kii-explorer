  ...
  <div>
    ...
    <div class="bg-base-100 dark:bg-base100 rounded mt-4 shadow">
        ...
        <table class="table table-compact w-full table-zebra">
          ...
          <tbody>
            <tr v-for="(item, index) in walletStore.delegations" :key="index">
              ...
              <td>
                <div>
                  <label for="delegate" class="btn !btn-xs !btn-primary hover:!text-black dark:hover:!text-white rounded-sm mr-2"
                    @click="dialog.open('delegate', { validator_address: item.delegation.validator_address }, updateState)">
                    {{ $t('account.btn_delegate') }}
                  </label>
                  <label for="withdraw" class="btn !btn-xs !btn-primary hover:!text-black dark:hover:!text-white btn-ghost rounded-sm"
      ...
      <div class="grid grid-cols-3 gap-4 px-4 pb-6 mt-4">
        <label for="PingTokenConvert" class="btn btn-primary hover:text-black dark:hover:text-white">{{ $t('index.btn_swap') }}</label>
