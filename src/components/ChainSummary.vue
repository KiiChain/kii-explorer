...
<template>
  <RouterLink
    :to="`/${name}`"
    class="bg-base-100 dark:bg-base100 hover:bg-gray-100 dark:hover:bg-[#373f59] rounded shadow flex items-center px-3 py-3 cursor-pointer rounded-xl overflow-hidden"
  >
