# kii
**kii** is a blockchain built using Cosmos SDK and Tendermint and created with [Ignite CLI](https://ignite.com/cli).
...
```
curl https://get.ignite.com/username/kii@latest! | sudo bash
```
